...
# translation
SOURCES = syncqgiswithdir.py ui_syncqgiswithdir.py __init__.py syncqgiswithdirdialog.py
#TRANSLATIONS = i18n/syncqgiswithdir_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = syncqgiswithdir

PY_FILES = syncqgiswithdir.py syncqgiswithdirdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_syncqgiswithdir.py
